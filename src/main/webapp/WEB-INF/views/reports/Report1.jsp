        ...
        <div class="sidebar">
          ...
          <div class="menu active">
            <ul class="menu-list">
              ...
              <li class="menu-item">
                <a href="#" class="menu-link">Employee management
                  <i class="fa-solid fa-plus"></i>
                </a>
              </li>
              <li class="menu-item">
                <a href="#" class="menu-link">Customer management
                  <i class="fa-solid fa-plus"></i>
                </a>
              </li>
              <li class="menu-item">
                <a href="#" class="menu-link">Vaccine type management
                  <i class="fa-solid fa-plus"></i>
                </a>
              </li>
              <li class="menu-item">
                <a href="#" class="menu-link">Vaccine management
                  <i class="fa-solid fa-plus"></i>
                </a>
              </li>
              <li class="menu-item">
                <a href="#" class="menu-link">Injection Schedule
                  <i class="fa-solid fa-plus"></i>
                </a>
              </li>
              <li class="menu-item">
                <a href="#" class="menu-link">Injection Result
                  <i class="fa-solid fa-plus"></i>
                </a>
              </li>
              <li class="menu-item">
                <a href="#" class="menu-link">News
                  <i class="fa-solid fa-plus"></i>
                </a>
              </li>
              <li class="menu-item">
                <a href="#" class="menu-link active" id="report-link">Report
                  <i class="fa-solid fa-plus" id="report-icon"></i>
                </a>
                <div class="report-hidden">
                  <ul>
                    ...
                    <li class="menu-item">
                      <a href="#" class="menu-link">Report Vaccine</a>
                    </li>
                  </ul>
                </div>
              </li>
        ...
        <div class="content">
          ...
          <div class="content-top">
            <div class="display-type">
              ...
              <input class="form-check-input" type="radio" id="report" name="display_type" value="report"/>
              <label for="report">Report</label>
              <input checked class="form-check-input" type="radio" id="chart" name="display_type" value="chart"/>
              <label for="chart">Chart</label>
            </div>
            <div class="chart-display">
              <label for="year">Select year:</label>
              <br/>
              <select class="form-select select-chart" name="year" id="year">
...
<script>
    ...
    <%--    console.log("hello");--%>
    <%--    $.ajax('${pageContext.request.contextPath}/report',   // request url--%>
    <%--        {--%>
    <%--            success: function (data, status, xhr) {// success callback function--%>
    <%--                window.history.pushState(null, null, "?test=abc")--%>
    <%--                console.log(data);--%>
    <%--            },--%>
    ...
    <%--        });--%>
    <%--});--%>
    var dataChar = [0, 0, 0, 0, 0, 0, 0, 1, 0, 1, 4, 1];
